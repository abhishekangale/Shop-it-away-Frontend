...
public class ProductsDetailFragment extends Fragment {
    ...
    ImageView imageView;
    String title, imageUrl, desc, userid, productid;
    int position = 0;
    int price = 0;
    int finalprice = 0;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        firestore.collection("items").document(productid).addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                String latestquantity = String.valueOf(product.getStock());
        ...
        addquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firestore.collection("items").document(productid).update("stock", quantity).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
