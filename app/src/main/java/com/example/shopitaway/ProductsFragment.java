...
import com.example.shopitaway.Adapter.ProductsAdapter;
import com.example.shopitaway.MVVM.ProductViewModel;
import com.example.shopitaway.Model.Cart;
...
public class ProductsFragment extends Fragment implements ProductsAdapter.OnClickedProducct{
    ...
    public void OnProClicked(List<Product> productList, int position) {
        ...
        actions.setTitle(productList.get(position).getName());
        ...
        actions.setImageUrl(productList.get(position).getImage());
